...
public abstract class PresenterManager {
    ...
    private static nucleus.manager.PresenterManager instance = new DefaultPresenterManager();

    /**
     * Returns a singleton instance of {@link nucleus.manager.PresenterManager}
     *
     * @return a singleton instance of {@link nucleus.manager.PresenterManager}
     */
    public static nucleus.manager.PresenterManager getInstance() {
        return instance;
    }

    /**
     * This is a testing facility.
     * Use this method to set a custom {@link nucleus.manager.PresenterManager} instance.
     *
     * @param instance a {@link nucleus.manager.PresenterManager} instance to set.
     */
    public static void setInstance(nucleus.manager.PresenterManager instance) {
        nucleus.manager.PresenterManager.instance = instance;
    }
